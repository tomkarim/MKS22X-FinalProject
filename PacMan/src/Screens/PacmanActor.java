...
public class PacmanActor extends InitActor{
    ...
    public void updatePlaying() {
        ...
        if (KeyListener.keyPressed[KeyEvent.VK_LEFT]) {
            desiredDirection = 2;
        }
        else if (KeyListener.keyPressed[KeyEvent.VK_RIGHT]) {
            desiredDirection = 0;
        }
        else if (KeyListener.keyPressed[KeyEvent.VK_UP]) {
            desiredDirection = 3;
        }
        else if (KeyListener.keyPressed[KeyEvent.VK_DOWN]) {
            desiredDirection = 1;
        }
    ...
    public void stateChanged() {
        ...
        else if (game.getState() == Pacman.State.READY2) {
            reset();
        }
        else if (game.getState() == Pacman.State.PLAYING) {
            instructionPointer = 0;
        }
        else if (game.getState() == Pacman.State.PACMAN_DIED) {
            instructionPointer = 0;
        }
        else if (game.getState() == Pacman.State.LEVEL_CLEARED) {
            frame = frames[0];
        }
    }
