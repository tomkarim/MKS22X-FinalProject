...
public class Ghost extends InitActor {
    ...
    public ArrayList<Integer> desiredDirections = new ArrayList<>();
    ...
    private PacmanCaughtAction pacmanCaughtAction = new PacmanCaughtAction();
    ...
    private void updateGhostNormal() {
        ...
        if (type == 0 || type == 1) {
            updateGhostMovement(true, pacman.col, pacman.row, 1, pacmanCaughtAction, 0, 1, 2, 3); // chase movement
        }
        else {
            updateGhostMovement(false, 0, 0, 1, pacmanCaughtAction, 0, 1, 2, 3); // random movement
        }
    }

    private GhostCaughtAction ghostCaughtAction = new GhostCaughtAction();
    ...
    private void updateGhostVulnerable() {
        ...
        updateGhostMovement(true, pacman.col, pacman.row, 1, ghostCaughtAction, 2, 3, 0, 1); // run away movement
